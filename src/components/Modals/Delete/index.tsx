    ...
    return (
        <div>
            <Transition appear show={isDeleteMessageModal} as={Fragment}>
                <Dialog as="div" open={isDeleteMessageModal} onClose={() => setIsDeleteMessageModal(false)}
                            ...
                            >
                                <DialogPanel
                                    ...
                                    <div className="p-5 text-center">
                                        <div
                                            className="text-white bg-danger ring-4 ring-danger/30 p-4 rounded-full w-fit mx-auto">
                                            <DynamicIcons name={'FaRegTrashAlt'} />
                                        </div>
                                        <div className="text-base sm:w-3/4 mx-auto mt-5">{t('message.deleteData')}</div>
