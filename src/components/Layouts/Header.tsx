                ...
                <div className="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black justify-between">
                    <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                        <Link to="/" className="main-logo flex items-center shrink-0">
                            ...
                            <span className="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle hidden md:inline dark:text-white-light transition-all duration-300">AthleteVision</span>
                        </Link>
                        <button
                            type="button"
                        ...
                        >
                            <DynamicIcons name="IoMenu" className="w-5 h-5"  />
                        </button>
                    </div>
                    ...
                    <div className="justify-end sm:flex-1 ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex items-center space-x-1.5 lg:space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
                        ...
                        <div className="dropdown shrink-0">
                            <Dropdown
                                ...
                                button={<DynamicIcons className="w-5 h-5 object-cover rounded-full" name="MdLanguage"/>}
                            >
                        ...
                        <div className="dropdown shrink-0 flex">
                            <Dropdown
                                ...
                                button={<DynamicIcons className="w-9 h-9 rounded-full object-cover saturate-50 group-hover:saturate-100" name="FaUser" />}
                            >
